...
export const CartContextProvider: React.FC<Props> = ( props: Props ) => {
    ...
    useEffect(()=>{
        const cartItems: any = localStorage.getItem('thunderCartItems')
    ...
    const handleAddProductToCart = useCallback((product: CartProductType)=> {
        setCartProducts((prev)=>{
            ...
            localStorage.setItem('thunderCartItems', JSON.stringify(updatedCart))
    ...
    const handleRemoveProductFromCart = useCallback((
        ...
        if(cartProducts){
            ...
            localStorage.setItem('thunderCartItems', JSON.stringify(filteredProducts))        }
    },[cartProducts])
    ...
    const handleClearCart = useCallback(()=>{
        ...
        localStorage.setItem('thunderCartItems', JSON.stringify(null))
    },[cartProducts])
